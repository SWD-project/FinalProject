...
public class TransactionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView coId = convertView.findViewById(R.id.course_id);
        TextView payment = convertView.findViewById(R.id.payment_course);
        TextView total = convertView.findViewById(R.id.total_course);

        GetTransactionRespone respone = list.get(position);
        coId.setText(respone.getCourseId().get_id());
        payment.setText((int) respone.getPayment());
        total.setText((int) respone.getTotal());
