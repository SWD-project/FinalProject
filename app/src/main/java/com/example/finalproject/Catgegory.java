...
public class Catgegory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarCatgegory.fab.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.catgegory, menu);
        return true;
    }
